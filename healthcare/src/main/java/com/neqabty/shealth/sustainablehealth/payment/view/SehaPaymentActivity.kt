...
import com.neqabty.shealth.databinding.ActivitySehaPaymentBinding
...
import com.neqabty.shealth.core.data.Constants.SANDBOX
import com.neqabty.shealth.core.ui.BaseActivity
import com.neqabty.shealth.auth.otp.view.VerifyPhoneActivity
import com.neqabty.shealth.sustainablehealth.receipt.view.paymentstatus.PaymentStatusActivity
import com.neqabty.shealth.sustainablehealth.payment.data.model.Payment
        ...
        paymentViewModel.paymentMethods.observe(this) { it ->
            ...
            it?.let { resource ->
                when (resource.status) {
                    com.neqabty.shealth.core.utils.Status.LOADING -> {
                        binding.progressCircular.visibility = View.VISIBLE
                    }
                    com.neqabty.shealth.core.utils.Status.SUCCESS -> {
                    ...
                    com.neqabty.shealth.core.utils.Status.ERROR -> {
                        binding.progressCircular.visibility = View.GONE
