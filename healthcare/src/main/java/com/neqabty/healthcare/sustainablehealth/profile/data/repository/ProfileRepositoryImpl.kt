package com.neqabty.healthcare.sustainablehealth.profile.data.repository


import com.neqabty.healthcare.sustainablehealth.profile.data.model.UpdatePasswordBody
import com.neqabty.healthcare.sustainablehealth.profile.data.model.profile.EntityBody
import com.neqabty.healthcare.sustainablehealth.profile.data.model.profile.ProfileModel
import com.neqabty.healthcare.sustainablehealth.profile.data.model.profile.UserData
import com.neqabty.healthcare.sustainablehealth.profile.data.model.updatepaswword.UpdatePasswordModel
import com.neqabty.healthcare.sustainablehealth.profile.data.source.ProfileDS
import com.neqabty.healthcare.sustainablehealth.profile.domain.entity.profile.Data
import com.neqabty.healthcare.sustainablehealth.profile.domain.entity.profile.Entity
