package com.neqabty.healthcare.sustainablehealth.splash.di

import com.neqabty.healthcare.sustainablehealth.splash.data.api.AppConfigApi
import com.neqabty.healthcare.sustainablehealth.splash.data.repository.AppConfigRepositoryImpl
