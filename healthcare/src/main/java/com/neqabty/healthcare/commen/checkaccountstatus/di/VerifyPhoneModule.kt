package com.neqabty.healthcare.commen.checkaccountstatus.di

import com.neqabty.healthcare.commen.checkaccountstatus.data.api.CheckAccountApi
import com.neqabty.healthcare.commen.checkaccountstatus.data.repository.CheckAccountRepositoryImpl
