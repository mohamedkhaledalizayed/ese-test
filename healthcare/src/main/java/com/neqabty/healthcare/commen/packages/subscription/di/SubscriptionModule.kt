package com.neqabty.healthcare.commen.packages.subscription.di


import com.neqabty.healthcare.commen.packages.subscription.data.api.SubscriptionApi
import com.neqabty.healthcare.commen.packages.subscription.data.repository.SubscriptionRepositoryImpl
