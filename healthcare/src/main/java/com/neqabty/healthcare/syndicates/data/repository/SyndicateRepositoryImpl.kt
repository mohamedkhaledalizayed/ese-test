package com.neqabty.healthcare.syndicates.data.repository

import com.neqabty.healthcare.syndicates.data.model.*
import com.neqabty.healthcare.syndicates.data.source.SyndicateDS
import com.neqabty.healthcare.syndicates.domain.entity.*
...
fun SyndicateModel.toSyndicateEntity(): SyndicateEntity {
    return SyndicateEntity(
        ...
        entityValidations = entityValidations.map { com.neqabty.healthcare.syndicates.domain.entity.EntityValidation(it.validationName, it.value)},
