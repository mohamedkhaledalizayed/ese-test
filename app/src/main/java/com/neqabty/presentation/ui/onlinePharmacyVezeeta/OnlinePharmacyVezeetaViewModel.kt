...
@HiltViewModel
class OnlinePharmacyVezeetaViewModel @Inject constructor(
    ...
    var viewState: MutableLiveData<OnlinePharmacyVezeetaViewState> = MutableLiveData()

    init {
        viewState.value = OnlinePharmacyVezeetaViewState()
    }
