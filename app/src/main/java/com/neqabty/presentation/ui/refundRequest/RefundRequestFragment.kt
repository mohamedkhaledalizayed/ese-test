...
import com.neqabty.databinding.RefundRequestFragmentBinding
...
import com.neqabty.presentation.ui.refund.RefundRequest
...
import kotlinx.android.synthetic.main.refund_request_fragment.*
import java.io.*
import java.util.*
import javax.inject.Inject

@AndroidEntryPoint
class RefundRequestFragment : BaseFragment() {
    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)
    var binding by autoCleared<RefundRequestFragmentBinding>()

    private val refundViewModel: RefundRequestViewModel by viewModels()
    ...
    lateinit var refundData: RefundRequest
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
                inflater,
                R.layout.refund_request_fragment,
                container,
                false,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        refundViewModel.errorState.observe(this, Observer { error ->
            showConnectionAlert(requireContext(), retryCallback = {
                ...
                refundViewModel.sendRefundRequest(sharedPref.name, sharedPref.mobile, sharedPref.user, refundData.benId, refundData.description, refundData.branchProfileId,
    ...
    private fun initializeViews() {
        refundData = RefundRequestFragmentArgs.fromBundle(requireArguments()).refundRequest
        binding.bSend.setOnClickListener {
            if (edDetails.text.toString().isNullOrBlank())
                ...
                refundViewModel.sendRefundRequest(sharedPref.name, sharedPref.mobile, sharedPref.user, refundData.benId, edDetails.text.toString(), refundData.branchProfileId,
                    sharedPref.token ,refundData.serviceProviderId, refundData.letterTypeId, attachments)
            }
        }
    ...
    private fun handleViewState(state: RefundRequestViewState) {
