...
@HiltViewModel
class MedicalSubventionInquiryViewModel @Inject constructor(
    ...
    var viewState: MutableLiveData<MedicalSubventionInquiryViewState> = MutableLiveData()

    init {
        viewState.value = MedicalSubventionInquiryViewState(isLoading = true)
    }
