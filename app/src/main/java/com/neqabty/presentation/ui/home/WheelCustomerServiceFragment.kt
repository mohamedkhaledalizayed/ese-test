...
import com.neqabty.databinding.WheelCustomerServiceFragmentBinding
...
class WheelCustomerServiceFragment : BaseFragment(), Injectable {
    @Inject
    lateinit var viewModelFactory: ViewModelProvider.Factory

    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)

    var binding by autoCleared<WheelCustomerServiceFragmentBinding>()
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
                inflater,
                R.layout.wheel_customer_service_fragment,
                container,
                false,
