package com.neqabty.presentation.ui.onlinePharmacyVezeeta
...
import com.neqabty.databinding.OnlinePharmacyVezeetaFragmentBinding
...
@AndroidEntryPoint
class OnlinePharmacyVezeetaFragment : BaseFragment(), OnBackPressedListener {

    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)

    var binding by autoCleared<OnlinePharmacyVezeetaFragmentBinding>()

    private val onlinePharmacyVezeetaViewModel: OnlinePharmacyVezeetaViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
                inflater,
                R.layout.online_pharmacy_vezeeta_fragment,
                container,
                false,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        onlinePharmacyVezeetaViewModel.viewState.observe(viewLifecycleOwner, Observer {
            if (it != null) handleViewState(it)
        })
        onlinePharmacyVezeetaViewModel.errorState.observe(this, Observer { error ->
