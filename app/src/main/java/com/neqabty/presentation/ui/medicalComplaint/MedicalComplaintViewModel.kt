...
@HiltViewModel
class MedicalComplaintViewModel @Inject constructor(
    ...
    var viewState: MutableLiveData<MedicalComplaintViewState> = MutableLiveData()

    init {
        viewState.value = MedicalComplaintViewState(isLoading = true)
    }
