...
class GetFavorites @Inject constructor(transformer: Transformer<List<ProviderEntity>>,
                                       private val neqabtyCache: NeqabtyCache) : UseCase<List<ProviderEntity>>(transformer) {
