...
class AddSyndicateServicesPaymentRequest @Inject constructor(
        transformer: Transformer<SyndicateServicesPaymentRequestEntity>,
        private val neqabtyRepository: NeqabtyRepository
) : UseCase<SyndicateServicesPaymentRequestEntity>(transformer) {
    ...
    override fun createObservable(data: Map<String, Any>?): Observable<SyndicateServicesPaymentRequestEntity> {
        ...
        return neqabtyRepository.addSyndicateServicesPaymentRequest(mobileNumber, userNumber, userName, serviceID.toInt(), countryID, paymentType, paymentGatewayId, deliveryType, address, mobile)
    }
}