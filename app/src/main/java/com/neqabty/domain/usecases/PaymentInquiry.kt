...
class PaymentInquiry @Inject constructor(
    ...
    fun paymentInquiry(isInquire: Boolean, mobileNumber: String, userNumber: String, userName: String, serviceID: Int, paymentType: String, paymentGatewayId: Int, locationType: Int, address: String, mobile: String): Observable<RenewalPaymentEntity> {
    ...
    override fun createObservable(data: Map<String, Any>?): Observable<RenewalPaymentEntity> {
        ...
        return neqabtyRepository.inquirePayment(isInquire, mobileNumber, userNumber, userName, serviceID.toInt(), paymentType, paymentGatewayId, deliveryType, address, mobile)
    }
}