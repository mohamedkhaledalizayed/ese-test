package me.relex.mycircleindicator;
...
public class Config {
    ...
    @DrawableRes int doneBackgroundId;
    ...
    public static class Builder {
        ...
        public Builder drawableDone(@DrawableRes int doneBackgroundId) {
            mConfig.doneBackgroundId = doneBackgroundId;
            return this;
        }
