...
class RegisterDS @Inject constructor(private val registerApi: RegisterApi) {
    suspend fun registerUser(phoneNumber:String,userId:String,countryCode:String = "+20",nationalId:String): RegistrationEntity {
        val response =  registerApi.register(mobile = phoneNumber, userId = userId,countryCode=countryCode, nationalId = nationalId)
